...
const ReviewMate = () => {
  return (
    <Fragment>
      ...
      <div className="absolute inset-0 flex flex-col text-black overflow-hidden justify-between">
        {/* <StarsAnimationIcon /> */}

        <div className="flex flex-col px-8 pt-6 pb-4 gap-2 justify-between">
          <h2 className="text-2xl sm:text-3xl lg:text-lg xl:text-xl text-black font-semibold">
            Simplifying Feedback for E-commerce.
          </h2>
          <p className="text-lg sm:text-xl lg:text-sm xl:text-lg">
            Shopify app for collecting reviews via email and automated prompts.
          </p>
        </div>

        {/* Rating Card */}
        <div className="flex items-center justify-center px-3 xl:px-8 pb-4">
