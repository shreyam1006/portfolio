...
export default function Contact() {
  return (
    <>
      ...
      <div className="grid grid-cols-4 gap-5 md:w-1/2">
        <BlackIconWrapper
          icon={faInstagram}
        ...
        <RedIconWrapper
          icon={faLinkedinIn}
          target="https://www.linkedin.com/in/shreyam1006"
        />
        <BlackIconWrapper
          icon={faGithub}
          target="https://github.com/shreyam1006"
        />
        <RedIconWrapper
          icon={faEnvelope}
          target="shreya.maheshwari.2000@gmail.com"
          isEmail
        />
      </div>
    </>
