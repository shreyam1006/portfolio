...
export default function Education() {
  ...
  return (
    <div
      className="flex flex-col-reverse items-center justify-center lg:block overflow-hidden"
    ...
    >
      ...
      >
        {isClicked ? (
          <g className="slide-section slide-down">
            <>Damn</>
          </g>
        ) : (
          <g className="slide-section">
            <path
        ...
        {isClicked ? (
          ...
          <g className="slide-section">
            ...
            <g
              id="eUbxc2KBHAG18_ts"
              transform="translate(227.5,169.75) scale(1,1)"
            >
              <path
      ...
      <div className="cursor-pointer hover:scale-105 transition-all bg-yellow w-fit px-5 py-2 m-3 border border-black lg:absolute">
